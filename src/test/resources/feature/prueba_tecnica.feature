# language: es
  ...
  @Escenario1
    Escenario:Ir a la web y precionar boton de registro
      ...
      Cuando llenamos el formulario de información personal con el nombre Nombre Apellido correo ejemplo3@gmail.com y la fecha de nacimiento February/20/2000
